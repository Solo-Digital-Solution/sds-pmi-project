        ...
        <div class="col-sm-8">
            ...
            <div class="page-title">
                ...
                <ol class="breadcrumb" style="background-color: transparent; margin-left:0px; margin-bottom:0px">
                    ...
                    <li class="breadcrumb-item" style="font-size:12pt">Form Laporan Situasi</li>
                </ol>
            </div>
        </div>
    </div>
                    ...
                    <div class="row gutters">
                        ...
                        <div class="col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="kontak" name="inputs[0][kontak]" type="tel" placeholder="Masukkan kontak" pattern="^[0-9]{10,15}$" title="Nomor telepon harus terdiri dari 10 hingga 15 digit angka dan hanya boleh berisi angka." oninvalid="this.setCustomValidity('Nomor telepon harus terdiri dari 10 hingga 15 digit angka dan hanya boleh berisi angka.')" oninput="this.setCustomValidity('');
                    ...
                    <div class="row gutters">
                        ...
                        <div class="col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="kontak" name="input[0][ktk]" type="tel" placeholder="Masukkan kontak" pattern="^[0-9]{10,15}$" title="Nomor telepon harus terdiri dari 10 hingga 15 digit angka dan hanya boleh berisi angka." oninvalid="this.setCustomValidity('Nomor telepon harus terdiri dari 10 hingga 15 digit angka dan hanya boleh berisi angka.')" oninput="this.setCustomValidity('');
                                        if(this.checkValidity()) {
                                            this.classList.add('valid-input');
                                        } else {
                                            this.classList.remove('valid-input');
