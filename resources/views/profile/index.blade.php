        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col">
                        <input type="text" value="Taehyung" class="form-control" id="fullName" placeholder="Nama Lengkap" disabled>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="username" class="col-sm-3 col-form-label">Username</label>
                    <div class="col">
                        <input type="text" value="taehyung123" class="form-control" id="username" placeholder="Alamat" disabled>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="user_id" class="col-sm-3 col-form-label">ID Pegawai</label>
                    <div class="col">
                        <input type="text" value="12345678" class="form-control" id="user_id" placeholder="Alamat" disabled>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="email" class="col-sm-3 col-form-label">Email</label>
                    <div class="col">
                        <input type="email" value="taehyung@example.com" class="form-control" id="email" placeholder="Email" disabled>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="phone" class="col-sm-3 col-form-label">Nomor Telepon</label>
                    <div class="col">
                        <input type="text" value="081234567890" class="form-control" id="phone" placeholder="Nomor Telepon" disabled>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="address" class="col-sm-3 col-form-label">Alamat</label>
                    <div class="col">
                        <input type="text" value="Jalanin Aja Dulu No. 123, Solo" class="form-control" id="address" placeholder="Alamat" disabled>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="gender" class="col-sm-3 col-form-label">Jenis Kelamin</label>
                    <div class="col">
                        <input type="text" value="Laki-laki" class="form-control" id="gender" placeholder="Alamat" disabled>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="goldar" class="col-sm-3 col-form-label">Golongan Darah</label>
                    <div class="col">
                        <input type="text" value="A" class="form-control" id="goldar" placeholder="Alamat" disabled>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="role" class="col-sm-3 col-form-label">Jabatan</label>
                    <div class="col">
                        <input type="text" value="Sukarelawan" class="form-control" id="gender" placeholder="Alamat" disabled>
                    </div>
                </div>
