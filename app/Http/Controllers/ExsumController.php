...
class ExsumController extends Controller
{
    ...
    // {
    //     $exsum = DB::table('kejadian')
    //         ->join('laporan', 'kejadian.id_kejadian', '=', 'laporan.id_kejadian')
    ...
    public function index()
    {
        $exsum = Kejadian::with('laporan')->paginate(10);
        ...
        // dd($barData); // To check the output
    ...
    public function search(Request $request)
    {
        ...
        $exsum = Kejadian::whereBetween('waktu_kejadian', [$tanggalAwal, $tanggalAkhir])
            ->with('laporan')
            ->paginate(10);
